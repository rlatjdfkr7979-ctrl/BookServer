...
const CONFIG = {
  spreadsheetId: getScriptProperty('SPREADSHEET_ID', 'PUT_YOUR_SPREADSHEET_ID_HERE'),
  booksSheetName: getScriptProperty('BOOKS_SHEET_NAME', 'Books'),
  librarySheetName: getScriptProperty('LIBRARY_SHEET_NAME', 'Library'),
...
function openSpreadsheet() {
  if (!CONFIG.spreadsheetId || CONFIG.spreadsheetId === 'PUT_YOUR_SPREADSHEET_ID_HERE') {
    throw new Error('Spreadsheet ID가 설정되지 않았습니다. 스크립트 속성에서 SPREADSHEET_ID를 설정하세요.');
  }
